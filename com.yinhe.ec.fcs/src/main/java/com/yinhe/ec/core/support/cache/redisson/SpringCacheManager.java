package com.yinhe.ec.core.support.cache.redisson;
...
public class SpringCacheManager implements CacheManager, ResourceLoaderAware, InitializingBean
{
	...
	/**
	 * Creates CacheManager supplied by Redisson instance and Cache config mapped by Cache name and RegExp config mapped
	 * by pattern.
	 * @param redisson
	 * object
	 * @param config
	...
	/**
	 * Creates CacheManager supplied by Redisson instance, Codec instance, Cache config mapped by Cache name and RegExp
	 * config mapped by pattern.
	 * <p>
	 * Each Cache instance share one Codec instance.
	 * @param redisson
	 * object
	 ...
	 * Creates CacheManager supplied by Redisson instance and Cache config mapped by Cache name.
	 * <p>
	 * Loads the config file from the class path, interpreting plain paths as class path resource names that include the
	 * package path (e.g. "mypackage/myresource.txt").
	 * @param redisson
	 * object
	...
	/**
	 * Creates CacheManager supplied by Redisson instance, Cache config location path and RegExp pattern config location
	 * path.
	 * <p>
	 * Loads the config file from the class path, interpreting plain paths as class path resource names that include the
	 * package path (e.g. "mypackage/myresource.txt").
	...
	/**
	 * Creates CacheManager supplied by Redisson instance, Codec instance, Config location path and RegExp config
	 * location path.
	 * <p>
	 * Each Cache instance share one Codec instance.
	 * <p>
