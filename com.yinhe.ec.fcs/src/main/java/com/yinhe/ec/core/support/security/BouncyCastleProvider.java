 ...
 * </pre>
 * <p>
 * The provider can also be configured as part of your environment via static registration by adding an entry to the
 * java.security properties file (found in $JAVA_HOME/jre/lib/security/java.security, where $JAVA_HOME is the location
 * of your JDK/JRE distribution). You'll find detailed instructions in the file but basically it comes down to adding a
 * line:
 *
 * <pre>
 * <code>
...
public class BouncyCastleProvider extends Provider
{
	...
	public BouncyCastleProvider()
	{
		...
		put("Alg.Alias.AlgorithmParameterGenerator.2.16.840.1.101.3.4.2", "AES"); // these first 3 are wrong, but seem
		// to have got around
		 ...
		 * "org.bouncycastle.jce.provider.JCEStreamCipher$IDEA_CFB8"); put("Alg.Alias.Cipher.DES/CFB8/NOPADDING",
		 * "DES/CFB8"); put("Alg.Alias.Cipher.DESEDE/CFB8/NOPADDING", "DESEDE/CFB8");
		 * put("Alg.Alias.Cipher.SKIPJACK/CFB8/NOPADDING", "SKIPJACK/CFB8");
		 * put("Alg.Alias.Cipher.BLOWFISH/CFB8/NOPADDING", "Blowfish/CFB8");
		 * put("Alg.Alias.Cipher.TWOFISH/CFB8/NOPADDING", "Twofish/CFB8"); put("Alg.Alias.Cipher.IDEA/CFB8/NOPADDING",
		 * "IDEA/CFB8"); put("Cipher.DES/OFB8", "org.bouncycastle.jce.provider.JCEStreamCipher$DES_OFB8");
		 ...
		 * put("Alg.Alias.Cipher.DES/OFB8/NOPADDING", "DES/OFB8"); put("Alg.Alias.Cipher.DESEDE/OFB8/NOPADDING",
		 * "DESEDE/OFB8"); put("Alg.Alias.Cipher.SKIPJACK/OFB8/NOPADDING", "SKIPJACK/OFB8");
		 * put("Alg.Alias.Cipher.BLOWFISH/OFB8/NOPADDING", "BLOWFISH/OFB8");
		 * put("Alg.Alias.Cipher.TWOFISH/OFB8/NOPADDING", "TWOFISH/OFB8"); put("Alg.Alias.Cipher.IDEA/OFB8/NOPADDING",
		 * "IDEA/OFB8");
		 */
