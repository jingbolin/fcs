...
public class TimeUtil
{
	...
	{
		return date.with((temporal) -> temporal.plus(-1, ChronoUnit.MONTHS).with(ChronoField.DAY_OF_MONTH, temporal.range(ChronoField.DAY_OF_MONTH).getMaximum()));
	}
	...
	{
		return date.with((temporal) -> temporal.with(ChronoField.DAY_OF_MONTH, temporal.range(ChronoField.DAY_OF_MONTH).getMaximum()));
	}
	...
	{
		return date.with((temporal) -> temporal.with(ChronoField.DAY_OF_YEAR, temporal.range(ChronoField.DAY_OF_YEAR).getMaximum()).plus(-1, ChronoUnit.YEARS));
	}
	...
	{
		return date.with((temporal) -> temporal.with(ChronoField.DAY_OF_YEAR, temporal.range(ChronoField.DAY_OF_YEAR).getMaximum()));
	}
