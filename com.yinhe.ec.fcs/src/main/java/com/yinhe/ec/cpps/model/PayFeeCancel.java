...
// Source File Name:   PayFeeCancel.java

package com.yinhe.ec.cpps.model;


public class PayFeeCancel
{
    ...
    public String getUnOperatorName()
    {
        return unOperatorName;
    }

    public void setUnOperatorName(String unOperatorName)
    {
        this.unOperatorName = unOperatorName;
    }
