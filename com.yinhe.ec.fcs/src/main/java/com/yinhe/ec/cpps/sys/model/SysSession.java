...
public class SysSession extends BaseModel implements Serializable
{
	...
	/**
	 * @param sessionId
	 * the value for sys_session.session_id
	 */
	...
	/**
	 * @param account
	 * the value for sys_session.account_
	 */
	...
	/**
	 * @param startTime
	 * the value for sys_session.start_time
	 */
