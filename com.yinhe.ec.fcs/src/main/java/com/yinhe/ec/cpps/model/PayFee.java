...
public class PayFee
{
    ...
    public String getFineRemitdesc()
    {
        return fineRemitdesc;
    }

    public void setFineRemitdesc(String fineRemitdesc)
    {
        this.fineRemitdesc = fineRemitdesc;
    }

    public Double getPayFeeDx()
    {
        return payFeeDx;
    }

    public void setPayFeeDx(Double payFeeDx)
    {
        this.payFeeDx = payFeeDx;
    }
    ...
    private String fineRemitdesc;
    private Double payFeeDx;
