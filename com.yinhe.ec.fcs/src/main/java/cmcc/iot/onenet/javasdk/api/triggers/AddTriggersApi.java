...
public class AddTriggersApi extends AbstractAPI {
    ...
    public AddTriggersApi(String title, String dsid, List<String> devids, List<String> dsuuids, String desturl, String type, Integer threshold, String key) {
        this.title = title;
        this.dsid = dsid;
        this.devids = devids;
    ...
    public BasicResponse<NewTriggersResponse> executeApi() {
        ...
        try {
            ...
            Object newData = this.mapper.readValue(this.mapper.writeValueAsString(response.getDataInternal()), NewTriggersResponse.class);
